...
/**
 ...
 `<-startWithEvergageAccountKey:dataset:>`. Finally, when the user is logged-in it is recommended to provide the `<userId>`
 ...
 ## Testing
 To easily and codelessly test unpublished campaigns, your app must add support for an
...
/**
 ...
 @deprecated As of 1.2.0
 */
- (void)includeTestCampaigns __attribute__((deprecated("Instead use handleOpenURL:")));
...
/**
 ...
 @deprecated As of 1.2.0
 */
- (BOOL)includeSpecificTestCampaignExperience:(nonnull NSString *)experienceId __attribute__((deprecated("Instead use handleOpenURL:")));
...
/**
 ...
 @deprecated As of 1.2.0
 */
- (void)disableTestCampaigns __attribute__((deprecated("Instead use handleOpenURL:")));
